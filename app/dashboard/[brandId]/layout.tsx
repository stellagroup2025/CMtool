          ...
          <div className="border-b border-border p-6 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">{brand.accounts.length} accounts</p>
              </div>
            </div>
          </div>
            ...
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.name}
                  {item.name === "Inbox" && brand.metrics.pendingDMs > 0 && (
                    <Badge className="ml-auto bg-primary text-primary-foreground">{brand.metrics.pendingDMs}</Badge>
                  )}
                </Button>
              )
            })}
